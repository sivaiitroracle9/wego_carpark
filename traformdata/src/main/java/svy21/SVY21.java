 ...
 *
 * ======================================================================================
 * Copied from https://github.com/cgcai/SVY21/blob/master/Java/net/qxcg/svy21/SVY21.java
 * ======================================================================================
 *
 * @author cgcai
 *
 * The svy21.SVY21 class provides functionality to convert between the svy21.SVY21 and Lat/Lon coordinate systems.
 *
...
public class SVY21 {
    ...
    /**
     * Computes Latitude and Longitude based on an svy21.SVY21 coordinate.
     *
     ...
     *
     * @param N Northing based on svy21.SVY21.
     * @param E Easting based on svy21.SVY21.
     * @return the conversion result a svy21.LatLonCoordinate.
     */
     ...
     * public svy21.LatLonCoordinate computeLatLon(double N, double E).
     *
     * @param coord an svy21.SVY21Coordinate object to convert.
     * @return the conversion result a svy21.LatLonCoordinate.
     */
    ...
    /**
     * Computes svy21.SVY21 Northing and Easting based on a Latitude and Longitude coordinate.
     *
     * This method returns an immutable svy21.SVY21Coordinate object that contains two fields,
     * northing, accessible with .getNorthing(), and
     * easting, accessible with .getEasting().
     *
     * @param lat latitude in degrees.
     * @param lon longitude in degrees.
     * @return the conversion result as an svy21.SVY21Coordinate.
     */
     ...
     *
     * This method is a shorthand for the functionally identical
     * public svy21.SVY21Coordinate computeSVY21(double lat, double lon).
     *
     * @param coord a svy21.LatLonCoordinate object to convert.
     * @return the conversion result an svy21.SVY21Coordinate.
     */
